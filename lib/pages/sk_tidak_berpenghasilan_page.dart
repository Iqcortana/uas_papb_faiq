...
class SKTidakBerpenghasilanPage extends StatelessWidget {
  const SKTidakBerpenghasilanPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Surat Keterangan Tidak Berpenghasilan Tetap'),
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            const Text(
              'Surat Keterangan Tidak Berpenghasilan Tetap',
            ...
            const SizedBox(height: 16),
            buildFileUploadBox(
                'Surat Pernyataan Tidak Berpenghasilan Tetap Bermaterai (.pdf)'),
            const SizedBox(height: 16),
